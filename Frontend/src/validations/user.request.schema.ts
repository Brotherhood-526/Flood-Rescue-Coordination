...
export const requestSchema = z.object({
  type: z.string().min(1, { message: "Vui lòng chọn phân loại cứu hộ" }),
  address: z
    .string()
    .min(5, { message: "Địa chỉ quá ngắn, vui lòng nhập đầy đủ!" }),
...
export type SubmittedRequestType = RequestSchemaType & {
  id: number;
};
